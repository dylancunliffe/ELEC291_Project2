...
int main(void)
{
  ...
  arm_rfft_fast_init_f32(&S, 1024); // Initialize the FFT engine
  /* USER CODE END 2 */
  ...
  while (1)
  {
	  if(data_ready_flag != 0){
		  ...
		  velocity = c * ((max_mag_index + 5) * (10000.0f / 1024.0f)) / (2.0f * 10.525 * 1000000000.0f); // in m/s
		  velocity *= 3.6; // convert to kmh
